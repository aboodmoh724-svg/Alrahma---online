    ...
    <main className="rahma-shell min-h-screen px-3 py-3 sm:px-5 sm:py-6">
      <div className="mx-auto max-w-7xl">
        <section className="rahma-card grid overflow-hidden rounded-[1.75rem] sm:rounded-[2.5rem] lg:min-h-[calc(100vh-3rem)] lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rahma-muted-pattern relative hidden overflow-hidden bg-[#0f5a35] lg:block">
            <div className="absolute -left-28 top-24 h-96 w-96 rounded-full bg-white/12" />
            <div className="absolute bottom-16 right-12 h-80 w-80 rounded-full bg-[#bd8f2d]/24" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#102a33] via-[#0f5a35]/70 to-[#f6eee7]/20" />
            ...
            <div className="absolute bottom-10 right-10 text-white">
              <p className="rounded-full bg-white/18 px-4 py-2 text-sm font-bold text-[#f2d18a]">المعلم</p>
