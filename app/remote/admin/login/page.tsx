      ...
      <div className="mx-auto max-w-7xl">
        <section className="rahma-card grid overflow-hidden rounded-[1.75rem] sm:rounded-[2.5rem] lg:min-h-[calc(100vh-3rem)] lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rahma-muted-pattern relative hidden overflow-hidden bg-[#102a33] lg:block">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#102a33] via-[#102a33]/75 to-[#0f5a35]/45" />
            ...
            <div className="absolute bottom-10 right-10 text-white">
              <p className="rounded-full bg-[#bd8f2d]/25 px-4 py-2 text-sm font-bold text-[#f2d18a]">الإدارة</p>
              <h2 className="mt-4 text-4xl font-black">الإدارة المالية والتشغيلية</h2>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-5 sm:p-8 md:p-14">
            <div className="w-full max-w-md">
              <div className="mb-5 flex items-center justify-between lg:hidden">
                ...
                <span className="rounded-full bg-[#fffaf4] px-4 py-2 text-xs font-bold text-[#8a661f] ring-1 ring-[#d8bf83]">الإدارة</span>
              </div>
              <LoginForm
                title="تسجيل دخول الإدارة"
                subtitle="أدخل بيانات الإدارة للوصول إلى لوحة الإدارة المالية والتشغيلية."
                rememberKey="alrahma_admin_login"
              />
            </div>
          </div>
        </section>
