...
export default async function OnsiteStudentHistoryPage({ params }: PageProps) {
            ...
            {student.reports.map((report) => (
              ...
              >
                ...
                <div className="grid gap-3 text-sm text-[#1c2d31]/75 md:grid-cols-2">
                  ...
                  <p>
                    <span className="font-black text-[#1c2d31]">واجب الغد: </span>
                    {report.nextHomework || "-"}
                  </p>
