    ...
    <main className="rahma-shell min-h-screen px-3 py-3 sm:px-5 sm:py-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-4 flex items-center justify-between sm:mb-6">
          ...
          <span className="rounded-full bg-[#bd8f2d]/15 px-4 py-2 text-sm font-bold text-[#8a661f]">{"\u062A\u0639\u0644\u064A\u0645 \u062D\u0636\u0648\u0631\u064A - \u0633\u0648\u0631\u064A\u0627"}</span>
        </div>
        ...
        <section className="rahma-card relative overflow-hidden rounded-[1.75rem] p-5 sm:rounded-[2.5rem] sm:p-8 md:p-12">
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-3xl font-black text-[#0f5a35] sm:text-4xl md:text-6xl">{"\u0627\u0644\u062A\u0639\u0644\u064A\u0645 \u0627\u0644\u062D\u0636\u0648\u0631\u064A - \u0633\u0648\u0631\u064A\u0627"}</h1>
          ...
          <div className="relative mx-auto mt-6 grid max-w-3xl gap-3 sm:mt-12 sm:gap-5 md:grid-cols-2">
            <Link href="/syria/admin/login" className="rounded-[1.5rem] bg-[#0a3f2a] p-5 text-center text-lg font-black text-white shadow-md transition hover:-translate-y-0.5 sm:rounded-[2rem] sm:p-8 sm:text-xl">
              دخول الإدارة
            </Link>
            <Link href="/syria/teacher/login" className="rounded-[1.5rem] bg-[#bd8f2d] p-5 text-center text-lg font-black text-white shadow-md transition hover:-translate-y-0.5 sm:rounded-[2rem] sm:p-8 sm:text-xl">
              دخول المعلم
            </Link>
          </div>
        </section>
